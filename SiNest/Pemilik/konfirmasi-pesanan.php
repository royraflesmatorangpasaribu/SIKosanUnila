                                    ...
                                    <tbody>
                                        <?php while ($result = mysqli_fetch_assoc($query_mysql)) { ?>
                                            <tr>
                                                ...
                                                <td><!-- Konfirmasi Kos Start -->
                                                    <?php if ($result['konfirmasi'] == 'Terkonfirmasi') { ?>
                                                        <h7 class="card-title"><button type="button" class="btn btn-outline-success btn-sm" style="background-color: #E3FFD9; color: #22CE2A;"><?php echo $result['konfirmasi']; ?></button></h7>
                                                    <?php } else { ?>
                                                        <h7 class="card-title"><button type="button" class="btn btn-outline-warning btn-sm"><?php echo $result['konfirmasi']; ?></button></h7>
                                                    <?php } ?>
                                                    <!-- Konfirmasi Kos End -->
                                                </td>
                                                ...
                                                <td>
                                                    <!-- Button Edit -->
                                                    <a href="edit-konfirmasi-pesan.php?update=<?php echo $result['id_transaksi']; ?>">
