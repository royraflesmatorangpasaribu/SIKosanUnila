                                        ...
                                        <td width="5000px">
                                            <form method="POST" action="" enctype="multipart/form-data">
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" class="form-control" id="namaLengkap" name="namaLengkap" value="<?php echo $result['nama_pemilik']; ?>">
                                                    </div>
                                                </div>
                                                <div class="mb-3 row">
...
if (isset($_POST['update'])) {
    ...
    if ($_FILES['foto']['error'] != 4) {
        ...
        if (in_array($foto_ext, $allowed_extensions)) {
            ...
            document.location='home-pemilik.php'</script>";
            exit();
        }
    } else {
    ...
    mysqli_query($mysqli, "UPDATE profilpemilik SET
    id_pemilik = 1,
    nama_pemilik = '$nama_admin',
    jenis_kelamin = '$jenis_kelamin',
    email = '$email',
    no_hp = '$no_hp',
    alamat = '$alamat',
    foto = '$foto' WHERE id_pemilik = 1") or die(mysqli_error($mysqli));
