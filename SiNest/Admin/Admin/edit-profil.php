...
$query_mysql = mysqli_query($mysqli, "SELECT * FROM profiladmin");
                                        ...
                                        <td width="5000px">
                                            <form method="POST" action="" enctype="multipart/form-data">
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" class="form-control" id="namaLengkap" name="namaLengkap" value="<?php echo $result['nama_admin']; ?>">
                                                    </div>
                                                </div>
                                                <div class="mb-3 row">
...
if (isset($_POST['update'])) {
    ...
    mysqli_query($mysqli, "UPDATE profiladmin SET
    id_admin = 1,
    ...
    no_hp = '$no_hp',
    alamat = '$alamat',
    foto = '$foto' WHERE id_admin = 1") or die(mysqli_error($mysqli));
